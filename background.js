...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _jobsFetcher = __webpack_require__(150);

	var _jobsFetcher2 = _interopRequireDefault(_jobsFetcher);
	...
	if (_jobsStorage2.default.getUnreadJobs().length > 0) {
	    chrome.browserAction.setBadgeBackgroundColor({ color: '#f44e42' });
	    _badge2.default.setCounter(_jobsStorage2.default.getUnreadJobs().length);
	}

	// initialize config
	_config2.default.setIsFetchingEnabled(1);
	_config2.default.setPlayNotificationSound(1);

	// initialize jobs fetching
	_jobsAlarm2.default.create(_config2.default.getInterval()); // in production minimum 1 minute
	_jobsFetcher2.default.fetchAndNotify();

	chrome.alarms.onAlarm.addListener(function (_ref) {
	    var name = _ref.name;
	    ...
	    _jobsStorage2.default.removeOldJobs();
	    _jobsFetcher2.default.fetchAndNotify();
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	     ...
	     * @return {Object}
	     */
	    feedRequest: function feedRequest() {
	        return _axios2.default.get('https://www.upwork.com/ab/find-work/api/feeds/search', {
	            headers: {
	    ...
	    checkAuthenticated: function checkAuthenticated() {
	        return _axios2.default.get('https://www.upwork.com/ab/account-security/login');
	    },
	     ...
	     * @return {undefined}
	     */
	    fetchAndNotify: function fetchAndNotify() {
	        var _this = this;
	        ...
	        this.fetch().then(function (response) {
	            ...
	            var freshJobs = _jobsStorage2.default.push(myJobs);
	            var unreadJobs = _jobsStorage2.default.getUnreadJobs();

	            bkg.console.log("freshJobs - ", freshJobs);
	            console.log("freshJobs - ", freshJobs);

	            _badge2.default.setCounter(unreadJobs.length);
	            _storage2.default.store('auth', true);

	            if (freshJobs.length > 0) {
	                _this.removeOldNotifications();
	                ...
	                if (!!JSON.parse(_config2.default.getPlayNotificationSound())) {
	            ...
	            if (err.response && err.response.status === 401) {
	                _storage2.default.store('auth', false);
	                _badge2.default.refresh();
	                _badge2.default.setText('err');
	            }
	        });
	    },
	     ...
	     * @return {undefined}
	     */
	    removeOldNotifications: function removeOldNotifications() {
